...
export function registerAllTools(server, workspaceManager) {
    // Workspace management tools
    server.tool('select_workspace', 'Set or validate the active project workspace directory containing .job-search/', {
    ...
    server.tool('get_workspace_info', 'Get information about the current or specified project workspace', {
