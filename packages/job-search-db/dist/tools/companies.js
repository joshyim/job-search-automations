...
export function registerCompanyTools(server, workspaceManager) {
    server.tool('list_companies', 'List all target companies, optionally including excluded ones', {
    ...
    server.tool('add_company', 'Add a new target company or update careers URL and notes if it already exists', {
        selected_directory: z.string().optional().describe('Path to the selected project workspace directory containing .job-search/'),
        directory: z.string().optional().describe('Alias for selected_directory'),
    ...
    server.tool('exclude_company', 'Mark a company as excluded without deleting it from the list', {
        selected_directory: z.string().optional().describe('Path to the selected project workspace directory containing .job-search/'),
        directory: z.string().optional().describe('Alias for selected_directory'),
    ...
    server.tool('update_company', 'Update details of an existing company (name, careers URL, excluded status, notes)', {
        selected_directory: z.string().optional().describe('Path to the selected project workspace directory containing .job-search/'),
        directory: z.string().optional().describe('Alias for selected_directory'),
    ...
    server.tool('get_batch', 'Get a batch of least-recently-searched companies for pipeline processing', {
        selected_directory: z.string().optional().describe('Path to the selected project workspace directory containing .job-search/'),
        directory: z.string().optional().describe('Alias for selected_directory'),
    ...
    server.tool('update_company_crawl_status', 'Updates timestamp and crawl status/notes of last crawl pass for a company', {
        selected_directory: z.string().optional().describe('Path to the selected project workspace directory containing .job-search/'),
        directory: z.string().optional().describe('Alias for selected_directory'),
